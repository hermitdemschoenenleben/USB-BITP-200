...
void base::write (address_t address, void *matrix, address_t columns, address_t rows) {
  std::lock_guard<std::mutex> lk(mutex_);
...
void base::read (address_t address, void *matrix, address_t columns, address_t rows) {
  std::lock_guard<std::mutex> lk(mutex_);
